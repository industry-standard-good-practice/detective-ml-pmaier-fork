...
const CaseReview: React.FC<CaseReviewProps> = ({ draftCase, originalBaseline, onUpdateDraft, onStart, onCancel, userId, userDisplayName, voicePreviewVolume = 0.12, onRegisterSave, onRegisterCheckConsistency, onRegisterClose, onHasUnsavedChanges }) => {
  ...
  // --- AUTO-GENERATE IMAGES: DISABLED ---
  // Image generation is now handled by the backend Eventarc worker (case-written).
  // Images populate automatically as the async pipeline runs.
  // Users can still manually regenerate individual portraits/evidence via the UI buttons.
  // The handleRetryAI function below is kept for user-triggered retry of missing images.
