...
def _init_firebase() -> None:
    ...
    if sa_key_json:
        ...
        # Will use Application Default Credentials (e.g. on GCP)
    ...
    print(f"[Firebase] Initialized (DB: {db_url or 'default'}, Bucket: {storage_bucket or 'default'})")
...
async def firebase_auth(request: Request, call_next):
    """Intercept all requests to verify Firebase auth, except health check."""
